...
const IntelligentAlertInputSchema = z.object({
  ...
  motion: z.string().describe('The user\'s current motion (e.g., running, walking, still).'),
...
const IntelligentAlertOutputSchema = z.object({
  alertType: z.string().describe('The type of alert to display (e.g., pre-risk, behavioral anomaly, silent SOS, dead-zone emergency, false-alarm suppression).'),
